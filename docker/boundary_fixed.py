"""
Fixed boundary.py from segger_dev (commit 5e83f87, Jul 31, 2025)
Contains fix for Qhull precision errors with degenerate point configurations.
"""
...
def vector_angle(v1, v2):
    ...
    # Avoid division by zero, clip the cosine values to [-1, 1] for numerical stability
